...
// Route::get('youtube', 'Api\Youtube\YoutubeController@show');
Route::get('/youtube/{channelName}', 'Api\Youtube\YoutubeController@show');
Route::post('/youtube', 'Api\Youtube\YoutubeController@store');